...
import net.tt64.nutz.plugin.coc.AnnotationIocLoader;
...
//		Object module2 = new OrdersController();
		...
		// init by ioc
		NutIoc ioc = new NutIoc(new ComboIocLoader(new JsonLoader("dao.js"),new AnnotationIocLoader("controllers")));
		Object module = ioc.get(clazz, clazz.getName());
		Method m2 = clazz.getMethod("create", new Class[0]);
