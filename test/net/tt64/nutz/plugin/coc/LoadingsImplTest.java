...
import static net.tt64.nutz.plugin.coc.Loadings.createInfo;
import static net.tt64.nutz.plugin.coc.Loadings.getContrllerModule;
import static net.tt64.nutz.plugin.coc.Loadings.getControllerName;
...
public class LoadingsImplTest {
	...
	public void testUtil(){
		...
		Assert.assertEquals("",getContrllerModule(Loadings.class));
