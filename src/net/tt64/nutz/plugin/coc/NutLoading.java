...
import net.tt64.nutz.plugin.scoffold.GenerateController;
...
public class NutLoading implements Loading {
    ...
    private UrlMapping evalUrlMapping(NutConfig config, Class<?> mainModule) throws Exception {
        ...
        for (Class<?> module : modules) {
        	try{
	        	if(Class.forName("net.tt64.nutz.plugin.scoffold.GenerateController") != null){
            ...
            for (Method method : module.getMethods()) {
                ...
                // 增加到映射中
                ActionInfo info = Loadings.createInfo(method,module).mergeWith(moduleInfo);
